...
if __name__ == '__main__':
    client = FastCGIClient('127.0.0.1', 9000, 3)
    params = dict()
    documentRoot = r"/data/conote/sandbox/2"
    filename = '/8380fb97-6f8c-4778-b1da-e573e7d47d2b.php'
    content = ''
    params = {
        'GATEWAY_INTERFACE': 'FastCGI/1.0',
        'REQUEST_METHOD': 'POST',
        'SCRIPT_FILENAME': os.path.join(documentRoot, filename[1:]),
